...
public class WrapList_string
{
	public static LuaMethod[] regs = new LuaMethod[]
	{
		...
		new LuaMethod("New", _CreateList_string),
	...
	static int _CreateList_string(IntPtr L)
	{
	...
	{
		LuaScriptMgr.RegisterLib(L, "List_string", typeof(List<string>), regs, fields, "System.Object");
	}
