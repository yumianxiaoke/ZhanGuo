...
public class WrapXMLDataTimes
{
	...
	{
		new LuaMethod("New", _CreateXMLDataTimes),
	...
	static int _CreateXMLDataTimes(IntPtr L)
	{
		int count = LuaDLL.lua_gettop(L);

		if (count == 0)
		{
			XMLDataTimes obj = new XMLDataTimes();
			LuaScriptMgr.PushObject(L, obj);
			return 1;
		}
		else
		{
			LuaDLL.luaL_error(L, "invalid arguments to method: XMLDataTimes.New");
		}
	...
	{
		LuaScriptMgr.RegisterLib(L, "XMLDataTimes", typeof(XMLDataTimes), regs, fields, "System.Object");
	}
