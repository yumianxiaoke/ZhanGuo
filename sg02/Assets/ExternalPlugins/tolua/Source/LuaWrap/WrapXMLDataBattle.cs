...
public class WrapXMLDataBattle
{
	...
	{
		new LuaMethod("New", _CreateXMLDataBattle),
	...
	static int _CreateXMLDataBattle(IntPtr L)
	{
		int count = LuaDLL.lua_gettop(L);

		if (count == 0)
		{
			XMLDataBattle obj = new XMLDataBattle();
			LuaScriptMgr.PushObject(L, obj);
			return 1;
		}
		else
		{
			LuaDLL.luaL_error(L, "invalid arguments to method: XMLDataBattle.New");
		}
	...
	{
		LuaScriptMgr.RegisterLib(L, "XMLDataBattle", typeof(XMLDataBattle), regs, fields, "System.Object");
	}
	...
	static int get_Battle1(IntPtr L)
	{
		...
		if (o == null)
		{
			...
			{
				LuaDLL.luaL_error(L, "attempt to index Battle1 on a nil value");
			}
		}
	...
	static int get_Battle2(IntPtr L)
	{
		...
		if (o == null)
		{
			...
			{
				LuaDLL.luaL_error(L, "attempt to index Battle2 on a nil value");
			}
		}
	...
	static int get_Battle3(IntPtr L)
	{
		...
		if (o == null)
		{
			...
			{
				LuaDLL.luaL_error(L, "attempt to index Battle3 on a nil value");
			}
		}
	...
	static int get_Battle4(IntPtr L)
	{
		...
		if (o == null)
		{
			...
			{
				LuaDLL.luaL_error(L, "attempt to index Battle4 on a nil value");
			}
		}
	...
	static int get_Battle5(IntPtr L)
	{
		...
		if (o == null)
		{
			...
			{
				LuaDLL.luaL_error(L, "attempt to index Battle5 on a nil value");
			}
		}
	...
	static int get_Battle6(IntPtr L)
	{
		...
		if (o == null)
		{
			...
			{
				LuaDLL.luaL_error(L, "attempt to index Battle6 on a nil value");
			}
		}
	...
	static int get_Battle7(IntPtr L)
	{
		...
		if (o == null)
		{
			...
			{
				LuaDLL.luaL_error(L, "attempt to index Battle7 on a nil value");
			}
		}
	...
	static int get_Battle8(IntPtr L)
	{
		...
		if (o == null)
		{
			...
			{
				LuaDLL.luaL_error(L, "attempt to index Battle8 on a nil value");
			}
		}
	...
	static int get_Battle9(IntPtr L)
	{
		...
		if (o == null)
		{
			...
			{
				LuaDLL.luaL_error(L, "attempt to index Battle9 on a nil value");
			}
		}
