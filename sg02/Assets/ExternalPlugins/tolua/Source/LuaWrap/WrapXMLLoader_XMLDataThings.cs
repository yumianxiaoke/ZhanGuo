...
public class WrapXMLLoader_XMLDataThings
{
	public static LuaMethod[] regs = new LuaMethod[]
	{
		...
		new LuaMethod("New", _CreateXMLLoader_XMLDataThings),
	...
	static int _CreateXMLLoader_XMLDataThings(IntPtr L)
	{
		...
		if (count == 1)
		{
			...
			XMLLoader<XMLDataThings> obj = new XMLLoader<XMLDataThings>(arg0);
		...
		else if (count == 2)
		{
			...
			XMLLoader<XMLDataThings> obj = new XMLLoader<XMLDataThings>(arg0,arg1);
			LuaScriptMgr.PushObject(L, obj);
			return 1;
		}
		else
		{
			LuaDLL.luaL_error(L, "invalid arguments to method: XMLLoader<XMLDataThings>.New");
		}
	...
	{
		LuaScriptMgr.RegisterLib(L, "XMLLoader<XMLDataThings>", typeof(XMLLoader<XMLDataThings>), regs, fields, "System.Object");
	}
