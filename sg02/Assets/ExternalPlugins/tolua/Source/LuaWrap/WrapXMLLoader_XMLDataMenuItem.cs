...
public class WrapXMLLoader_XMLDataMenuItem
{
	public static LuaMethod[] regs = new LuaMethod[]
	{
		...
		new LuaMethod("New", _CreateXMLLoader_XMLDataMenuItem),
	...
	static int _CreateXMLLoader_XMLDataMenuItem(IntPtr L)
	{
		...
		if (count == 1)
		{
			...
			XMLLoader<XMLDataMenuItem> obj = new XMLLoader<XMLDataMenuItem>(arg0);
		...
		else if (count == 2)
		{
			...
			XMLLoader<XMLDataMenuItem> obj = new XMLLoader<XMLDataMenuItem>(arg0,arg1);
			LuaScriptMgr.PushObject(L, obj);
			return 1;
		}
		else
		{
			LuaDLL.luaL_error(L, "invalid arguments to method: XMLLoader<XMLDataMenuItem>.New");
		}
	...
	{
		LuaScriptMgr.RegisterLib(L, "XMLLoader<XMLDataMenuItem>", typeof(XMLLoader<XMLDataMenuItem>), regs, fields, "System.Object");
	}
