...
public class WrapXMLLoader_XMLDataLanguage
{
	public static LuaMethod[] regs = new LuaMethod[]
	{
		...
		new LuaMethod("New", _CreateXMLLoader_XMLDataLanguage),
	...
	static int _CreateXMLLoader_XMLDataLanguage(IntPtr L)
	{
		...
		if (count == 1)
		{
			...
			XMLLoader<XMLDataLanguage> obj = new XMLLoader<XMLDataLanguage>(arg0);
		...
		else if (count == 2)
		{
			...
			XMLLoader<XMLDataLanguage> obj = new XMLLoader<XMLDataLanguage>(arg0,arg1);
			LuaScriptMgr.PushObject(L, obj);
			return 1;
		}
		else
		{
			LuaDLL.luaL_error(L, "invalid arguments to method: XMLLoader<XMLDataLanguage>.New");
		}
	...
	{
		LuaScriptMgr.RegisterLib(L, "XMLLoader<XMLDataLanguage>", typeof(XMLLoader<XMLDataLanguage>), regs, fields, "System.Object");
	}
