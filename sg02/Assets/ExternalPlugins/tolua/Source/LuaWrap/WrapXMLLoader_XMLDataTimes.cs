...
public class WrapXMLLoader_XMLDataTimes
{
	public static LuaMethod[] regs = new LuaMethod[]
	{
		...
		new LuaMethod("New", _CreateXMLLoader_XMLDataTimes),
	...
	static int _CreateXMLLoader_XMLDataTimes(IntPtr L)
	{
		...
		if (count == 1)
		{
			...
			XMLLoader<XMLDataTimes> obj = new XMLLoader<XMLDataTimes>(arg0);
		...
		else if (count == 2)
		{
			...
			XMLLoader<XMLDataTimes> obj = new XMLLoader<XMLDataTimes>(arg0,arg1);
			LuaScriptMgr.PushObject(L, obj);
			return 1;
		}
		else
		{
			LuaDLL.luaL_error(L, "invalid arguments to method: XMLLoader<XMLDataTimes>.New");
		}
	...
	{
		LuaScriptMgr.RegisterLib(L, "XMLLoader<XMLDataTimes>", typeof(XMLLoader<XMLDataTimes>), regs, fields, "System.Object");
	}
