...
public class WrapXMLDataGenerals
{
	...
	{
		new LuaMethod("New", _CreateXMLDataGenerals),
	...
	static int _CreateXMLDataGenerals(IntPtr L)
	{
		int count = LuaDLL.lua_gettop(L);

		if (count == 0)
		{
			XMLDataGenerals obj = new XMLDataGenerals();
			LuaScriptMgr.PushObject(L, obj);
			return 1;
		}
		else
		{
			LuaDLL.luaL_error(L, "invalid arguments to method: XMLDataGenerals.New");
		}
	...
	{
		LuaScriptMgr.RegisterLib(L, "XMLDataGenerals", typeof(XMLDataGenerals), regs, fields, "System.Object");
	}
	...
	static int get_Total(IntPtr L)
	{
		...
		if (o == null)
		{
			...
			{
				LuaDLL.luaL_error(L, "attempt to index Total on a nil value");
			}
		}
	...
	static int get_TimesState(IntPtr L)
	{
		...
		if (o == null)
		{
			...
			{
				LuaDLL.luaL_error(L, "attempt to index TimesState on a nil value");
			}
		}
	...
	static int get_UseBattleArray(IntPtr L)
	{
		...
		if (o == null)
		{
			...
			{
				LuaDLL.luaL_error(L, "attempt to index UseBattleArray on a nil value");
			}
		}
	...
	static int get_LoyalKing(IntPtr L)
	{
		...
		if (o == null)
		{
			...
			{
				LuaDLL.luaL_error(L, "attempt to index LoyalKing on a nil value");
			}
		}
	...
	static int get_Blood(IntPtr L)
	{
		...
		if (o == null)
		{
			...
			{
				LuaDLL.luaL_error(L, "attempt to index Blood on a nil value");
			}
		}
	...
	static int get_Constancy(IntPtr L)
	{
		...
		if (o == null)
		{
			...
			{
				LuaDLL.luaL_error(L, "attempt to index Constancy on a nil value");
			}
		}
	...
	static int get_Flags(IntPtr L)
	{
		...
		if (o == null)
		{
			...
			{
				LuaDLL.luaL_error(L, "attempt to index Flags on a nil value");
			}
		}
