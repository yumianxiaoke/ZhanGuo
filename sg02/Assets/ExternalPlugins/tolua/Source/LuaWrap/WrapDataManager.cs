...
public class WrapDataManager
{
	public static LuaMethod[] regs = new LuaMethod[]
	{
		...
		new LuaMethod("New", _CreateDataManager),
	...
	{
		LuaScriptMgr.RegisterLib(L, "DataManager", typeof(DataManager), regs, fields, "System.Object");
	}
	...
	static int get_Kings(IntPtr L)
	{
		...
		if (o == null)
		{
			...
			{
				LuaDLL.luaL_error(L, "attempt to index Kings on a nil value");
			}
		}
