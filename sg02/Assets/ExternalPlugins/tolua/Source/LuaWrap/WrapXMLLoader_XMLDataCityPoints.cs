...
public class WrapXMLLoader_XMLDataCityPoints
{
	public static LuaMethod[] regs = new LuaMethod[]
	{
		...
		new LuaMethod("New", _CreateXMLLoader_XMLDataCityPoints),
	...
	static int _CreateXMLLoader_XMLDataCityPoints(IntPtr L)
	{
		...
		if (count == 1)
		{
			...
			XMLLoader<XMLDataCityPoints> obj = new XMLLoader<XMLDataCityPoints>(arg0);
		...
		else if (count == 2)
		{
			...
			XMLLoader<XMLDataCityPoints> obj = new XMLLoader<XMLDataCityPoints>(arg0,arg1);
			LuaScriptMgr.PushObject(L, obj);
			return 1;
		}
		else
		{
			LuaDLL.luaL_error(L, "invalid arguments to method: XMLLoader<XMLDataCityPoints>.New");
		}
	...
	{
		LuaScriptMgr.RegisterLib(L, "XMLLoader<XMLDataCityPoints>", typeof(XMLLoader<XMLDataCityPoints>), regs, fields, "System.Object");
	}
