...
public class WrapXMLLoader_XMLDataAnimations
{
	public static LuaMethod[] regs = new LuaMethod[]
	{
		...
		new LuaMethod("New", _CreateXMLLoader_XMLDataAnimations),
	...
	static int _CreateXMLLoader_XMLDataAnimations(IntPtr L)
	{
		...
		if (count == 1)
		{
			...
			XMLLoader<XMLDataAnimations> obj = new XMLLoader<XMLDataAnimations>(arg0);
		...
		else if (count == 2)
		{
			...
			XMLLoader<XMLDataAnimations> obj = new XMLLoader<XMLDataAnimations>(arg0,arg1);
			LuaScriptMgr.PushObject(L, obj);
			return 1;
		}
		else
		{
			LuaDLL.luaL_error(L, "invalid arguments to method: XMLLoader<XMLDataAnimations>.New");
		}
	...
	{
		LuaScriptMgr.RegisterLib(L, "XMLLoader<XMLDataAnimations>", typeof(XMLLoader<XMLDataAnimations>), regs, fields, "System.Object");
	}
