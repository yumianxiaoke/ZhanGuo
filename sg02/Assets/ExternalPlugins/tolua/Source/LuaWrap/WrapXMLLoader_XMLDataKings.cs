...
public class WrapXMLLoader_XMLDataKings
{
	public static LuaMethod[] regs = new LuaMethod[]
	{
		...
		new LuaMethod("New", _CreateXMLLoader_XMLDataKings),
	...
	static int _CreateXMLLoader_XMLDataKings(IntPtr L)
	{
		...
		if (count == 1)
		{
			...
			XMLLoader<XMLDataKings> obj = new XMLLoader<XMLDataKings>(arg0);
		...
		else if (count == 2)
		{
			...
			XMLLoader<XMLDataKings> obj = new XMLLoader<XMLDataKings>(arg0,arg1);
			LuaScriptMgr.PushObject(L, obj);
			return 1;
		}
		else
		{
			LuaDLL.luaL_error(L, "invalid arguments to method: XMLLoader<XMLDataKings>.New");
		}
	...
	{
		LuaScriptMgr.RegisterLib(L, "XMLLoader<XMLDataKings>", typeof(XMLLoader<XMLDataKings>), regs, fields, "System.Object");
	}
