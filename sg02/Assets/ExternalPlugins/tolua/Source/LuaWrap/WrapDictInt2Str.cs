...
public class WrapDictInt2Str
{
	public static LuaMethod[] regs = new LuaMethod[]
	{
		...
		new LuaMethod("New", _CreateDictInt2Str),
	...
	static int _CreateDictInt2Str(IntPtr L)
	{
	...
	{
		LuaScriptMgr.RegisterLib(L, "DictInt2Str", typeof(Dictionary<int,string>), regs, fields, "System.Object");
	}
