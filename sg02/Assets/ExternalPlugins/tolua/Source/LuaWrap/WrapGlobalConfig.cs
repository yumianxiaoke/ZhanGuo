...
public class WrapGlobalConfig
{
	public static LuaMethod[] regs = new LuaMethod[]
	{
		...
		new LuaMethod("New", _CreateGlobalConfig),
	...
	static LuaField[] fields = new LuaField[]
	{
		...
		new LuaField("TroopFlag", get_TroopFlag, null),
		new LuaField("FlagOffset1", get_FlagOffset1, null),
		new LuaField("FlagOffset2", get_FlagOffset2, null),
		new LuaField("FlagOffset3", get_FlagOffset3, null),
		new LuaField("FlagOffset4", get_FlagOffset4, null),
	};

	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int _CreateGlobalConfig(IntPtr L)
	{
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_TroopFlag(IntPtr L)
	{
		LuaScriptMgr.Push(L, GlobalConfig.TroopFlag);
		return 1;
	}

	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_FlagOffset1(IntPtr L)
	{
		LuaScriptMgr.PushValue(L, GlobalConfig.FlagOffset1);
		return 1;
	}

	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_FlagOffset2(IntPtr L)
	{
		LuaScriptMgr.PushValue(L, GlobalConfig.FlagOffset2);
		return 1;
	}

	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_FlagOffset3(IntPtr L)
	{
		LuaScriptMgr.PushValue(L, GlobalConfig.FlagOffset3);
		return 1;
	}

	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_FlagOffset4(IntPtr L)
	{
		LuaScriptMgr.PushValue(L, GlobalConfig.FlagOffset4);
		return 1;
	}
