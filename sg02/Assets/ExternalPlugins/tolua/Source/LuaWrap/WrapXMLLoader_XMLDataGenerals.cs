...
public class WrapXMLLoader_XMLDataGenerals
{
	public static LuaMethod[] regs = new LuaMethod[]
	{
		...
		new LuaMethod("New", _CreateXMLLoader_XMLDataGenerals),
	...
	static int _CreateXMLLoader_XMLDataGenerals(IntPtr L)
	{
		...
		if (count == 1)
		{
			...
			XMLLoader<XMLDataGenerals> obj = new XMLLoader<XMLDataGenerals>(arg0);
		...
		else if (count == 2)
		{
			...
			XMLLoader<XMLDataGenerals> obj = new XMLLoader<XMLDataGenerals>(arg0,arg1);
			LuaScriptMgr.PushObject(L, obj);
			return 1;
		}
		else
		{
			LuaDLL.luaL_error(L, "invalid arguments to method: XMLLoader<XMLDataGenerals>.New");
		}
	...
	{
		LuaScriptMgr.RegisterLib(L, "XMLLoader<XMLDataGenerals>", typeof(XMLLoader<XMLDataGenerals>), regs, fields, "System.Object");
	}
