...
public class WrapXMLDataKings
{
	...
	{
		new LuaMethod("New", _CreateXMLDataKings),
	...
	static int _CreateXMLDataKings(IntPtr L)
	{
		int count = LuaDLL.lua_gettop(L);

		if (count == 0)
		{
			XMLDataKings obj = new XMLDataKings();
			LuaScriptMgr.PushObject(L, obj);
			return 1;
		}
		else
		{
			LuaDLL.luaL_error(L, "invalid arguments to method: XMLDataKings.New");
		}
	...
	{
		LuaScriptMgr.RegisterLib(L, "XMLDataKings", typeof(XMLDataKings), regs, fields, "System.Object");
	}
	...
	static int get_FlagAnim(IntPtr L)
	{
		...
		if (o == null)
		{
			...
			{
				LuaDLL.luaL_error(L, "attempt to index FlagAnim on a nil value");
			}
		}
