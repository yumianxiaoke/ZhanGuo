...
public class WrapMapCameraControl
{
	public static LuaMethod[] regs = new LuaMethod[]
	{
		...
		new LuaMethod("New", _CreateMapCameraControl),
	...
	static int _CreateMapCameraControl(IntPtr L)
	{
	...
	{
		LuaScriptMgr.RegisterLib(L, "MapCameraControl", typeof(MapCameraControl), regs, fields, "Singleton`1[MapCameraControl]");
	}
